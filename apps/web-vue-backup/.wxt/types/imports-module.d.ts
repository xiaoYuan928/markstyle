...
declare module '#imports' {
  ...
  export { addPrefix, downloadMD, getHtmlContent, exportHTML, generatePureHTML, exportPureHTML, exportPDF, solveWeChatImage, processClipboardContent, LocalEngine, RestfulEngine, checkImage, createTable, downloadFile, formatDoc, removeLeft, sanitizeTitle, toBase64, modifyHtmlContent, postProcessHtml, renderMarkdown } from '../src/utils/index';
  export { setupComponents } from '../src/utils/setup-components';
  export { LocalStorageEngine, LocalStorageEngine, RestfulStorageEngine, RestfulStorageEngine, store, StorageEngine } from '../src/utils/storage';
}
